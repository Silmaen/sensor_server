...
from mqtt_bridge.services import handle_sensor_message, handle_status_message, parse_topic
from mqtt_bridge.topics import TOPIC_SENSORS, TOPIC_STATUS
...
class Command(BaseCommand):
    ...
    def _on_connect(self, client, userdata, flags, reason_code, properties):
        if reason_code == 0:
            ...
            client.subscribe([(TOPIC_SENSORS, 1), (TOPIC_STATUS, 1)])
        else:
